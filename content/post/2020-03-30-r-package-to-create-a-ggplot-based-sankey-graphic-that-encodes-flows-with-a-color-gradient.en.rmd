---
title: "ggSankeyGrad: an R Package to Create a Ggplot Based Sankey Graphic That Encodes Flows With a Color Gradient"
...
Let's consider a second example. This data is inspired by Giorgia Lupi's award-winning infographic, [Nobels, No Degrees](https://www.informationisbeautifulawards.com/showcase/204-nobels-no-degrees). We prepare the data in the same format as before, which encodes the categories of Nobel winners and from which of several schools they are associated, if any.
