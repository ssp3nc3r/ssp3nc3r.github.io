...
$$
Then, to solve for $u$, we can take the log of each side and solve for $x$^[My favorite book to refresh on basic algebra here is Simmons, George F. Precalculus Mathematics in a Nutshell. Geometry, Algebra, Trigonometry. Eugene OR: Resource Publications, 1987.],
...
functions {
  ...
  real weibull_rng(real eta, real lambda, real beta) {
      real u = uniform_rng(0, 1.0);
      return ( log(1 - u) / -eta ) ^ inv(lambda) + beta;
  }
